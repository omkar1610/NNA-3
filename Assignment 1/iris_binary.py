...
if __name__ == '__main__':
    ...
    # combining the 1st and 2nd class i.e. Iris Versicolour and Iris Virginica
    Y = list(map(lambda x: 1 if x == 2 else x, Y))
    ...
    print("\nAccuracy : ")
    print("Train Accuracy : ", model.accuracy(
        list(Y_tr), model.predict(list(X_tr))))
    print("Test Accuracy : ", model.accuracy(
        list(Y_ts), model.predict(list(X_ts))))
